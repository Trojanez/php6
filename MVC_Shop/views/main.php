...
<body>
	<div id="wrapper">
            ...
            <div class="layout">
                <div class="all">
                    ...
                    <div id="modal_form"><!-- Сaмo oкнo -->
                        ...
                        <form method="post" id="insert_form">
                            ...
                            <input type="email" id="email_reg" /><br/>
                    ...
                    <div id="modal_form1"><!-- Сaмo oкнo -->
                        ...
                        <form method="post" action="">
                            <label for="email">Электронный адрес:</label><br/>
                            <input type="email" id="email_auth" /><br/>
                            <label for="pass">Пароль:</label><br/>
                            <input type="password" id="password_auth" name="password" /><br/>
                ...
                <!-- Пункт меню 1 -->
                            <li class="parent"><a href="/category-alcohol/">Алкогольные напитки</a>
                                <ul>
                                    <li><a href="/category-alcohol-vodka/">Водка</a></li>
        ...
        <!-- Конец списка -->
                    ...
                    <ul class="bxslider">
                        <li><img src="/template/images/Nemmir.jpg" width="1200px" height="400px"/></li>
                        <li><img src="/template/images/Coca-cola.jpg" width="1200px" height="400px"/></li>
                        <li><img src="/template/images/Korona_LeoProduct.jpg" width="1200px" height="400px"/></li>
                    </ul>
                </div>
            </div>
            <div id="main">
